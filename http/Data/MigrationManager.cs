	...
	public class MigrationManager
	{
		...
		private static void EnsureConnectionAvailable(string connectionString)
		{
			...
			try
			{
				...
				{
					connection.Open();
					Trace.WriteLine(string.Format("Connection to {0}[{1}] {2} successful.", connection.DataSource, connection.ServerVersion, connection.Database));
				}
			}
